"""It's possible this entire approach is wrong"""
...
# TODO this function requests M, does it really need it?
def bishop_threats (N,i, current_column, threatened):
...
# TODO rewrite to follow same format as otehrs
def rook_threats (N,i,current_column, threatened):
# Horizontal
    threatened.add(i)
    for t in range (1,N):
...
def queen_threats( N,i, current_column, threatened):
    #TODO make sure this works as expected
    threatened=bishop_threats(N,i,current_column,threatened)
    threatened=rook_threats(N,i,current_column,threatened)
    return(threatened)